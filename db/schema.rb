...
ActiveRecord::Schema.define(version: 2021_03_15_224738) do

  create_table "camp_item_relations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "camp_id", null: false
    t.bigint "item_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["camp_id"], name: "index_camp_item_relations_on_camp_id"
    t.index ["item_id"], name: "index_camp_item_relations_on_item_id"
  end
  ...
  add_foreign_key "camp_item_relations", "camps"
  add_foreign_key "camp_item_relations", "items"
